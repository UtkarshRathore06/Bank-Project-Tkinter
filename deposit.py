...
class AmountDeposit(Frame):
    def __init__(self,m):
        super().__init__(m)
        
        self.l1=Label(self,text='Account No')
        self.l2=Label(self,text='Amount Deposit')
        self.t1=Entry(self)
        self.t2=Entry(self)
        self.b1=Button(self,text='Deposit Amount',command=self.call)
    ...
    def call(self):
        ...
        ob=utility()
        mes=ob.depositaccount(acno,amt)
